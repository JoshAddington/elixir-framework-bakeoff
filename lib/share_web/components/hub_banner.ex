defmodule ShareWeb.HubBanner do
  ...
  def hub_banner(assigns) do
    ...
    <div
      ...
      class="mb-8 w-full flex items-center justify-between gap-4 p-6 bg-white rounded-[8px] border border-black/5 shadow-[0px_1px_3px_rgba(0,0,0,0.02),0px_8px_24px_-4px_rgba(15,23,42,0.04)]"
    >
      ...
      <div class="flex items-center gap-4">
        <.link
          ...
          class="shrink-0 bg-slate-900 text-white px-6 py-2.5 rounded-xl text-sm font-bold shadow-lg shadow-slate-900/10 hover:bg-slate-800 hover:-translate-y-0.5 transition-all"
        >
          View Your Resources
        </.link>
